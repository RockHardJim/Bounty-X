...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/bounties', [
        'as' => 'bounties',
        'uses' => 'LandingController@bounties'
    ]);
    
    Route::get('/bounty/{id}', [
        'as' => 'bounty',
        'uses' => 'LandingController@bounty'
    ]);
    
    Route::get('/bounty-form', [
    'as' => 'bountyform',
    'uses' => 'FormController@register'
    ]);
    
    Route::post('/bounty-submit', [
    'as' => 'bounty-submit',
    'uses' => 'FormController@doregister'
    ]);
