...
<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('user.list')); ?>"><?php echo app('translator')->getFromJson('app.users'); ?></a>
    </li>
            ...
            <div class="card-body">
                <h5 class="card-title">
                    ...
                    <small class="float-right">
                        <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="edit"
            ...
            <div class="card-body">
                <h5 class="card-title">
                    ...
                    <?php if(count($userActivities)): ?>
                        <small class="float-right">
                            <a href="<?php echo e(route('activity.user', $user->id)); ?>" class="edit"
