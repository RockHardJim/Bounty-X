                            ...
                            <?php foreach($bounties as $bounty){ ?>
									<div class="listar-themepost listar-placespost">
										<figure class="listar-featuredimg">
											<a href="http://localhost/citizen4/public/bounty/<?php echo $bounty->id; ?>"><img src="<?php echo e(url('upload/images/')); ?>/<?php echo $bounty->image; ?>" alt="image description"></a>
	               ...
	               "listing": [
                    {
			             ...
			             "image": "<?php echo e(url('upload/images/')); ?>/<?php echo $bounty->image; ?>",
