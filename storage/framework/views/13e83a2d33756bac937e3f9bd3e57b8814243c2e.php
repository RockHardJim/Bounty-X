...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="tab-content mt-4" id="nav-tabContent">
                    <div class="tab-pane fade show active px-2" id="details" role="tabpanel" aria-labelledby="nav-home-tab">
                        <?php echo Form::open(['route' => 'profile.update.details', 'method' => 'PUT', 'id' => 'details-form']); ?>

                            <?php echo $__env->make('user.partials.details', ['profile' => true], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::close(); ?>

                    </div>

                    <div class="tab-pane fade px-2" id="login-details" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <?php echo Form::open(['route' => 'profile.update.login-details', 'method' => 'PUT', 'id' => 'login-details-form']); ?>

                            <?php echo $__env->make('user.partials.auth', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::close(); ?>
                    ...
                    <?php if(settings('2fa.enabled')): ?>
                        <div class="tab-pane fade px-2" id="2fa" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <?php echo Form::open(['route' => "profile.two-factor.{$route}", 'id' => 'two-factor-form']); ?>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <?php echo Form::open(['route' => 'profile.update.avatar', 'files' => true, 'id' => 'avatar-form']); ?>

                    <?php echo $__env->make('user.partials.avatar', ['updateUrl' => route('profile.update.avatar-external')], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::close(); ?>
